<?php
  ...
  class proc_role_permissions_cls extends godfessi_godfessions_baseClass {
    ...
    private $validaterole_id = false;
    private $validatepermission_ids = false;
    ...
    private $proc        = true;
    private $mainDBtable = "role_permissions";
    private $statMsg     = "";
    ...
    public function __construct($inparams=array()) {
      if (!empty($inparams)) {
        if (isset($inparams['role_permissions_id']) && ($inparams['role_permissions_id'] != "")) $this->procarr['id'] = $this->id =  $inparams['role_permissions_id'];
        if (isset($inparams['role_id']) && ($inparams['role_id'] != "")) $this->procarr['role_id'] = $this->role_id =  $inparams['role_id'];
        if (isset($inparams['permission_ids']) && ($inparams['permission_ids'] != "")) $this->procarr['permission_ids'] = $this->permission_ids =  $inparams['permission_ids'];
      ...
      public function save_role_permissions() {
        if($this->id == "") return dosave_role_permissions();
        if($this->id != "") return doupdate_role_permissions();
      }

      public function dosave_role_permissions() {
        ...
        if (($this->proc == true) && ($this->validaterole_id == true) && ($this->role_id == "")) {
          $this->proc    = false;
          $this->statMsg = "role_id can not be empty, pls correct to continue.";
        }

        if (($this->proc == true) && ($this->validatepermission_ids == true) && ($this->permission_ids == "")) {
          $this->proc    = false;
          $this->statMsg = "permission_ids can not be empty, pls correct to continue.";
        }
      ...
      public function doupdate_role_permissions() {
        if($this->proc == true) {
      ...
      public function get_role_permissions() {
        ...
        if ($this->role_id != "") $getParam['AND=>role_id'] = "=~$this->role_id";
        if ($this->permission_ids != "") $getParam['AND=>permission_ids'] = "=~$this->permission_ids";
        ...
        if ($this->actualact == "getdrops") {
          ...
          $j=0;
          foreach ($reton as $reta) {
            $this->returnArr[$j]['role_permissions_id'] = $reta['id'];
            $this->returnArr[$j]['role_id'] = $reta['role_id'];
            $this->returnArr[$j]['permission_ids'] = $reta['permission_ids'];
            $this->returnArr[$j]['created'] = $reta['created'];
            $this->returnArr[$j]['modified'] = $reta['modified'];
            $j+=1;
          }
        } else if($this->actualact == "getSingle") {
            $this->returnArr[0]['role_permissions_id'] = $reton[0]['id'];
            $this->returnArr[0]['role_id'] = $reton[0]['role_id'];
            $this->returnArr[0]['permission_ids'] = $reton[0]['permission_ids'];
