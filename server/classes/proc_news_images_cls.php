<?php
  ...
  class proc_news_images_cls extends godfessi_godfessions_baseClass {
    ...
    private $proc        = true;
    private $mainDBtable = "news_images";
    private $statMsg     = "";
    ...
    public function __construct($inparams=array()) {
      if (!empty($inparams)) {
        if (isset($inparams['news_images_id']) && ($inparams['news_images_id'] != "")) $this->procarr['id'] = $this->id =  $inparams['news_images_id'];
      ...
      public function save_news_images() {
        if($this->id == "") return dosave_news_images();
        if($this->id != "") return doupdate_news_images();
      }

      public function dosave_news_images() {
      ...
      public function doupdate_news_images() {
        if($this->proc == true) {
      ...
      public function get_news_images() {
        ...
        if ($this->actualact == "getdrops") {
          ...
          $j=0;
          foreach ($reton as $reta) {
            $this->returnArr[$j]['news_images_id'] = $reta['id'];
            ...
            $this->returnArr[0]['news_images_id'] = $reton[0]['id'];
